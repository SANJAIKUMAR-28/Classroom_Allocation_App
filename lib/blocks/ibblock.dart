...
class _ibBlockState extends State<ibBlock> {
        ...
        child: Column(
          ...
          children: [
            if(request['CLASS-TYPE']=='Classroom'&&((int.parse(request['STRENGTH'])>=strength)&& clsvalue==true )&&!(request['SPEAKER-PROJECTOR']=='No'&&spvalue==true)&&!(request['COMPUTER']=='No'&&comvalue==true))
              ibclass(request['CLASS-NAME'], request['STRENGTH'], request['SPEAKER-PROJECTOR'], request['COMPUTER'],request['FLOOR']),
  ...
  Material ibclass(String classnum,String strength,String speakerAndprojector,String ac,String floor) {
    return Material(
      elevation: 4,
      color: Colors.white,
      ...
      child: MaterialButton(
        ...
        minWidth: MediaQuery
            ...
            .width,
        onPressed: () async {
          Navigator.push(context, MaterialPageRoute(builder: (context)=>newdetail(name1: classnum,totalstrength: strength,)));
        },
        child: Row(
          children: [
