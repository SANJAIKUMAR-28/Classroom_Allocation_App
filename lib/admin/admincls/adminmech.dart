...
class adminmech extends StatefulWidget {
  const adminmech({Key? key}) : super(key: key);
...
class _adminmechState extends State<adminmech> {
  ...
  DatabaseReference reference = FirebaseDatabase.instance.ref().child('MECHCLASS');
        ...
        child: Column(
          ...
          children: [
            if(request['CLASS-TYPE']=='Classroom'&&((int.parse(request['STRENGTH'])>=strength)&& clsvalue==true )&&!(request['SPEAKER-PROJECTOR']=='No'&&spvalue==true)&&!(request['COMPUTER']=='No'&&comvalue==true))
              mechclass(request['CLASS-NAME'], request['STRENGTH'], request['SPEAKER-PROJECTOR'], request['COMPUTER'],request['key'],request['FLOOR']),
  ...
  Material mechclass(String classnum,String strength,String speakerAndprojector,String ac,String key,String floor) {
    return Material(
      elevation: 4,
      color: Colors.white,
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text('commputer:', style: TextStyle(fontWeight: FontWeight.normal,
                        fontFamily: 'Arimo',
                        color: Colors.black,
                        fontSize: 10),),
                    SizedBox(width: 5,),
                            ...
                            actions: <Widget>[
                              ...
                              TextButton(onPressed: () {
                                if(clsname.text.length==0){
                                  reference.child(key).update({'CLASS-NAME':classnum.toString()});}
                                else{
                                  reference.child(key).update({'CLASS-NAME':clsname.text.toString()});}
